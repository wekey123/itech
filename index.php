...
<div class="page">
    ...
    <main>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-sm-7 col-xs-12 col-off-xs center-media-xs">
                                    ...
                                    <div class="btn-wrap">
                                        <a href="ecommerce.php" class="btn-primary btn-primary__md">Learn about us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div data-src="images/page-1_slide02.jpg">
                    <div class="camera_caption fadeIn">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-5 col-xs-12 col-off-xs center-media-lg">
                                    <span class="icon-wrap fa-apple"></span>
                                </div>
                                <div class="col-sm-7 col-xs-12 col-off-xs center-media-xs">
                                    <h2><strong>iPhone Application</strong><br>
                                        iPhone Mobile Development</h2>

                                    <p class="font-primary indent">The introductions of iPhones were one 
									of the best things that happened to the industry. The use of iPhone 
                ...
                <div data-src="images/page-1_slide03.jpg">
                    <div class="camera_caption fadeIn">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-5 col-xs-12 col-off-xs center-media-lg">
                                    <span class="icon-wrap fa-android"></span>
                                </div>
                                <div class="col-sm-7 col-xs-12 col-off-xs center-media-xs">
                                    <h2><strong>Android Application</strong><br>
                ...
                <div class="row row__off  grid-off">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay="0.8s">
                        <div class="icon-block fa-shopping-cart">
                            <h5>
                                <a href='ecommerce.php'>E-commerce Development</a>
                            </h5>
                     ...
                     <div class="col-md-4 col-sm-6 col-xs-12 wow fadeInRight" data-wow-delay="0.8s">
                        <div class="icon-block fa-connectdevelop">
                            <h5>
                                <a href='ecommerce.php'>Web Development</a>
                            </h5>
        ...
        <section class="parallax" data-url="images/parallax1.jpg" data-mobile="true" data-speed="1">
            <div class="bg-primary well-2">

                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-off-xs wow fadeInLeft" data-wow-delay="0.2s">
                            <h2 class="title-wrap  fa-wrench"><strong>Technology</strong><br>
                                Evolves and Changes</h2>
                        </div>
                        <div class="col-md-5 col-media wow fadeInRight" data-wow-delay="0.2s">
                            <p class="font-primary off">Technology evolves and changes quickly and it is a challenge to keep pace with the emerging trends. We have been an early adapter of newer technologies in iPhone, Blackberry and Android Applications and have set up its respective Center of Excellence (COE).
							Our expertise in mobile technology and framework development has helped in the quick growth.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row row__off-1">
                    ...
                    <div class="col-md-4 col-sm-12 wow fadeInRight" data-wow-delay="0.4s">
                        <h5>
                            <a href='javascript:void(0);'>Professional Services & Testing</a>
                        </h5>
                    ...
                    <div class="col-md-4 col-sm-12 wow fadeInRight" data-wow-delay="0.6s">
                        <h5>
                            <a href='javascript:void(0);'>SalesForce Analytics</a>
                        </h5>
        ...
        <section class="parallax" data-url="images/parallax1.jpg" data-mobile="true" data-speed="1">
            <div class="bg-img-primary">  </div>

                <div class="bg-secondary  well  well__off">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-7 col-off-xs wow fadeInUp">
                                <h2><strong>Get in Touch?</strong> Make call with us!</h2>

                                <p class="offset">Got an Awsome idea? For Free proposal and analysis of your needs, please shoot us an message. We will Contact you shortly.
                                  </p>
                                <a href="callto:714-646-3709" class="btn-default">Call Us</a>
                            </div>
                        </div>
